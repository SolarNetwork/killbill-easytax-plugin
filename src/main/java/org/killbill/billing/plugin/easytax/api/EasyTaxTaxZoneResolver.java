...
/**
 * Resolver API for tax zones.
 * 
 * @author matt
 */
public interface EasyTaxTaxZoneResolver {
    ...
    /**
     * Resolve a tax zone for an invoice.
     * 
     * <p>
     ...
     * @return the tax zone
     */
    String taxZoneForInvoice(UUID kbTenantId, Account account, Invoice invoice,
